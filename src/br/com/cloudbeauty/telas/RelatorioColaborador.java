 ...
 * @author Debug
 */
public class RelatorioColaborador extends javax.swing.JDialog {

    /**
     * Creates new form RelatorioColaborador
     */
    public RelatorioColaborador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        comboOrdem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "Documento", "Data de Início", "Data de Saída" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioColaborador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RelatorioColaborador dialog = new RelatorioColaborador(new javax.swing.JFrame(), true);
