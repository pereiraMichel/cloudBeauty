...
public class RelatorioUsuarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comboOrdem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "E-mail", "Status", "Acesso" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RelatorioUsuarios dialog = new RelatorioUsuarios(new javax.swing.JFrame(), true);
